...
## 更新摘要
**变更内容**
- 更新了可视化编辑按钮的实现细节，明确了可视化编辑功能的使用限制
- 可视化编辑按钮现在仅适用于FileHelper命令执行器，其他命令类型不再显示该按钮
- 在前端渲染逻辑中添加了命令执行器类型判断，根据commandExecutor属性动态控制按钮显示
...
**更新** 本次更新重点反映了应用变更：更新了可视化编辑按钮的实现细节，明确了可视化编辑功能的使用限制 - 仅适用于FileHelper命令执行器，其他命令类型不再显示可视化编辑按钮。
...
- [AnythingService.cs:534-632](file://Sylas.RemoteTasks.App/RemoteHostModule/Anything/AnythingService.cs#L534-L394)
...
- [HostsController.cs:83-122](file://Sylas.RemoteTasks.App/Controllers/HostsController.cs#L83-L122)
- [AnythingService.cs:293-394](file://Sylas.RemoteTasks.App/RemoteHostModule/Anything/AnythingService.cs#L293-L394)
- [AnythingService.cs:664-678](file://Sylas.RemoteTasks.App/RemoteHostModule/Anything/AnythingService.cs#L664-L678)
- [ICommandExecutor.cs:30-70](file://Sylas.RemoteTasks.Utils/CommandExecutor/ICommandExecutor.cs#L30-L70)
- [SystemCmd.cs:129-138](file://Sylas.RemoteTasks.Utils/CommandExecutor/SystemCmd.cs#L129-L138)
- [FileHelper.cs:27-28](file://Sylas.RemoteTasks.Utils/CommandExecutor/FileHelper.cs#L27-L28)
- [anything.js:370-387](file://Sylas.RemoteTasks.App/wwwroot/js/anything.js#L370-L387)
...
**章节来源**
- [anything.js:291-293](file://Sylas.RemoteTasks.App/wwwroot/js/anything.js#L291-293)
- [anything.js:338-339](file://Sylas.RemoteTasks.App/wwwroot/js/anything.js#L338-339)
- [anything.js:371-387](file://Sylas.RemoteTasks.App/wwwroot/js/anything.js#L371-387)
