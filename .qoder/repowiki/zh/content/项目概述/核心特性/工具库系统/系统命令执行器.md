...
**更新** 本次更新新增了 ExecuteByInterpreterAsync 方法，支持 Linux 风格的 shebang 语法，可自动识别并执行 bash、Python、PowerShell、Node.js 等多种脚本类型。同时增强了脚本库提供者功能，支持多语言公共脚本片段的集中管理和分发。
...
**图表来源**
- [SystemCmd.cs:138-147](file://Sylas.RemoteTasks.Utils/CommandExecutor/SystemCmd.cs#L138-L147)
- [SystemCmd.cs:226-304](file://Sylas.RemoteTasks.Utils/CommandExecutor/SystemCmd.cs#L226-L304)
...
- 临时文件管理
  - 为每次执行创建带时间戳的临时目录，执行完成后仅保留最近 100 个临时目录，其余删除。
- 资源清理
...
**章节来源**
- [SystemCmd.cs:138-147](file://Sylas.RemoteTasks.Utils/CommandExecutor/SystemCmd.cs#L138-L147)
- [SystemCmd.cs:153-219](file://Sylas.RemoteTasks.Utils/CommandExecutor/SystemCmd.cs#L153-L219)
- [SystemCmd.cs:226-304](file://Sylas.RemoteTasks.Utils/CommandExecutor/SystemCmd.cs#L226-L304)
- [SystemCmd.cs:484-560](file://Sylas.RemoteTasks.Utils/CommandExecutor/SystemCmd.cs#L484-L560)
- [SystemCmd.cs:567-598](file://Sylas.RemoteTasks.Utils/CommandExecutor/SystemCmd.cs#L567-L598)
...
**图表来源**
- [SystemCmd.cs:226-304](file://Sylas.RemoteTasks.Utils/CommandExecutor/SystemCmd.cs#L226-L304)
- [SystemCmd.cs:312-403](file://Sylas.RemoteTasks.Utils/CommandExecutor/SystemCmd.cs#L312-L403)
...
- [SystemCmd.cs:323-331](file://Sylas.RemoteTasks.Utils/CommandExecutor/SystemCmd.cs#L323-L331)
- [SystemCmd.cs:682-682](file://Sylas.RemoteTasks.Utils/CommandExecutor/SystemCmd.cs#L682-L682)
